function [seeddag hiddenGraph_Ps SampleDistribution allscore] = hmdbn_structEM(TimeSeriesData, seed, print, condition)
...
complete = 0;
search_idx = 0;
filename = sprintf('/home/ags72/scratch/Checkpoints/%s_checkpoint%d.mat', condition, search_idx);
